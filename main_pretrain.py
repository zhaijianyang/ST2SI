...
from data_utils import load_pretrain_data, tokenize_items
from data_pretrain import RecDataset, ItemDataset, Collator
...
def main():
    ...
    args.logger = logger
    interactions, item_meta_dict = load_pretrain_data(args)
    args.item_num = len(item_meta_dict)
    ...
    train_dataset = RecDataset(interactions, tokenized_items, args, 'train', tokenizer)
    val_dataset = RecDataset(interactions, tokenized_items, args, 'valid', tokenizer)
    test_dataset = RecDataset(interactions, tokenized_items, args, 'test', tokenizer)
